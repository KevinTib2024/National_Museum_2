...
namespace National_Museum_2.Context
{
    public class MuseumDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //PermissionXUserType
            modelBuilder.Entity<PermissionXUserType>().HasOne(pu => pu.permissions).WithMany(p => p.permissionXUserTypes).HasForeignKey(pu => pu.permissionXUserTypeId);
            modelBuilder.Entity<PermissionXUserType>().HasOne(pu => pu.userType).WithMany(ut => ut.permissionsXUserType).HasForeignKey(pu => pu.userType_Id);
            ...
            //EmployesXArtRoom
            modelBuilder.Entity<EmployeesXArtRoom>().HasOne(ea => ea.employee).WithMany(e => e.employeesXArtRooms).HasForeignKey(ea => ea.employeeId);
            modelBuilder.Entity<EmployeesXArtRoom>().HasOne(ea => ea.artRoom).WithMany(ar => ar.employeesXArtRoom).HasForeignKey(ea => ea.artRoomId);
            ...
            modelBuilder.Entity<Employees>().HasOne(e => e.maintenance).WithMany(m => m.employees).HasForeignKey(e => e.maintenance_Id);
            ...
            //TicketXCollection
            modelBuilder.Entity<TicketXCollection>().HasOne(tc => tc.collection).WithMany(c => c.ticketXCollections).HasForeignKey(tc => tc.collection_Id);
            modelBuilder.Entity<TicketXCollection>().HasOne(tc => tc.Ticket).WithMany(c => c.ticketXCollections).HasForeignKey(tc => tc.Ticket_Id);
